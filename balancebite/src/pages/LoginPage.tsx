...
export function LoginPage() {
  ...
  const inputClassName = `w-full h-12 md:h-14 rounded-full bg-[#EFEFEF] px-5 md:px-6 text-[16px] md:text-[18px] text-[#8A8A8A] placeholder:text-[#B0B0B0] outline-none border transition-all duration-200 focus:border-[#67B76D] focus:shadow-[0_4px_10px_rgba(103,183,109,0.35)] ${
